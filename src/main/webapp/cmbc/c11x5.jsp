...
<div class="page-from-left index">
    <div class="top fix">
        <div class="top-relative clearfix">
            ...
            <span class="title"><span class="pt2">11选5</span><a class="selmore" href="javascript:void(-1)">任选五<img
    ...
    <div class="content">
        ...
        <div class="xuanqiu">
            ...
            <div class="tab-content p10" id="putong" style="display:block" data-red="5" data-blue="0" data-des="任选五">
                <p class="gerytext pl10">玩法提示：从11个号码中任选5个号码，1/462的中奖机会，奖金540元</p>
            ...
            <div class="tab-content p10" id="dantuo">
                <p class="gerytext pl10">玩法提示：胆码可选1-4个，拖码可选2-10个，胆码加拖码>=6个，奖金540元</p>
                <span class="tz-tit-left"><font class="redtext">胆码区</font>至少选择1个，最多选择4个</span>
                ...
                <span class="tz-tit-left mt10"><font class="redtext">拖码区</font>胆码与托码个数之和至少6个</span>
