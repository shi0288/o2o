...
<div class="page-from-left index">
	<div class="top fix">
    	<div class="top-relative clearfix">
        	...
        	<span class="title"><span class="pt2">11选5</span><a class="selmore" href="javascript:void(-1)">任选二<img src="img/down_yellow.png"/></a></span>
        </div>
    </div>
    <div class="cb"></div>
<!--顶部结束-->
<!--正文内容开始-->
	<div class="content">
        ...
        <div class="xuanqiu">
            ...
            <div class="tab-content p10" id="putong" style="display:block" data-red="2" data-blue="0" data-des="任选二">
            	<p class="gerytext pl10">玩法提示：从11个号码中任选2个号码。1/5.5的中奖机会，奖金6元。</p>
            ...
            <div class="tab-content p10" id="dantuo">
            	<p class="gerytext pl10">玩法提示：胆码选1个，拖码可选2-10个，胆码加拖码>=3个，奖金6元。</p>
                <span class="tz-tit-left"><font class="redtext">胆码区</font>请选择1个号码</span>
                <div class="cb"></div>
...
<!--投注底部开始-->
    ...
    <div id="game" style="display:none" data-game="T05" data-play="22"></div>
</div>
<!--弹出层-->
<div class="cover"></div>
