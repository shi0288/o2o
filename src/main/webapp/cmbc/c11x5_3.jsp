...
<div class="page-from-left index">
	<div class="top fix">
    	<div class="top-relative clearfix">
        	...
        	<span class="title"><span class="pt2">11选5</span><a class="selmore" href="javascript:void(-1)">任选三<img src="img/down_yellow.png"/></a></span>
        </div>
    </div>
    <div class="cb"></div>
<!--顶部结束-->
<!--正文内容开始-->
	...
	<div class="content">
        ...
        <div class="xuanqiu">
            ...
            <div class="tab-content p10" id="putong" style="display:block" data-red="3" data-blue="0" data-des="任选三">
            	<p class="gerytext pl10">玩法提示：从11个号码中任选3个号码，1/16.5的中奖机会，奖金19元。</p>
                <span class="tz-tit-left">至少选3个号码</span>
                <span class="tz-tit-right1 red" id="jx-hq">3个</span>
                <span class="tz-tit-right2 red" onClick="selqiu($('#putong').find('.redball'),3)">机选红球</span>
                <div class="cb"></div>
            ...
            <div class="tab-content p10" id="dantuo">
            	<p class="gerytext pl10">玩法提示：胆可码选1-2个，拖码可选2-10个，胆码加拖码>=4个，奖金19元。</p>
...
<!--投注底部开始-->
    ...
    <div id="game" style="display:none" data-game="T05" data-play="23"></div>
</div>
<!--弹出层-->
<div class="cover"></div>
