...
<div class="page-from-left index">
	<div class="top fix">
    	<div class="top-relative clearfix">
        	...
        	<span class="title"><span class="pt2">11选5</span><a class="selmore" href="javascript:void(-1)">任选四<img src="img/down_yellow.png"/></a></span>
        </div>
    </div>
    <div class="cb"></div>
<!--顶部结束-->
<!--正文内容开始-->
	...
	<div class="content">
        ...
        <div class="xuanqiu">
            ...
            <div class="tab-content p10" id="putong" style="display:block" data-red="4" data-blue="0" data-des="任选四">
            	<p class="gerytext pl10">玩法提示：从11个号码中任选4个号码。1/66的中奖机会，奖金78元。</p>
                <span class="tz-tit-left">至少选4个号码</span>
                <span class="tz-tit-right1 red" id="jx-hq">4个</span>
                <span class="tz-tit-right2 red" onClick="selqiu($('#putong').find('.redball'),4)">机选号码</span>
                <div class="cb"></div>
            ...
            <div class="tab-content p10" id="dantuo">
            	<p class="gerytext pl10">玩法提示：胆可码选1-3个，拖码可选2-10个，胆码加拖码>=5个，奖金78元。</p>
                <span class="tz-tit-left"><font class="redtext">胆码区</font>至少选择1个，最多选择3个</span>
                <div class="cb"></div>
                ...
                <span class="tz-tit-left mt10"><font class="redtext">拖码区</font>胆码与托码个数之和至少5个</span>
                <div class="cb"></div>
...
<!--投注底部开始-->
    ...
    <div id="game" style="display:none" data-game="T05" data-play="24"></div>
</div>
<!--弹出层-->
<div class="cover"></div>
<div class="pop pop-red-div clearfix">
	<span class="pop-red">4</span>
