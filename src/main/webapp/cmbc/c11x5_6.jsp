...
<div class="page-from-left index">
	<div class="top fix">
    	<div class="top-relative clearfix">
        	...
        	<span class="title"><span class="pt2">11选5</span><a class="selmore" href="javascript:void(-1)">任选六<img src="img/down_yellow.png"/></a></span>
        </div>
    </div>
    <div class="cb"></div>
<!--顶部结束-->
<!--正文内容开始-->
	...
	<div class="content">
        ...
        <div class="xuanqiu">
            ...
            <div class="tab-content p10" id="putong" style="display:block" data-red="6" data-blue="0" data-des="任选六">
            	<p class="gerytext pl10">玩法提示：从11个号码中任选6个号码。1/77的中奖机会，奖金90元。</p>
                <span class="tz-tit-left">至少选6个号码</span>
                <span class="tz-tit-right1 red" id="jx-hq">6个</span>
                <span class="tz-tit-right2 red" onClick="selqiu($('#putong').find('.redball'),6)">机选号码</span>
                <div class="cb"></div>
            ...
            <div class="tab-content p10" id="dantuo">
            	<p class="gerytext pl10">玩法提示：胆可码选1-5个，拖码可选2-10个，胆码加拖码>=7个，奖金90元。</p>
                <span class="tz-tit-left"><font class="redtext">胆码区</font>至少选择1个，最多选择5个</span>
                <div class="cb"></div>
                ...
                <span class="tz-tit-left mt10"><font class="redtext">拖码区</font>胆码与托码个数之和至少7个</span>
                <div class="cb"></div>
...
<!--投注底部开始-->
    ...
    <div id="game" style="display:none" data-game="T05" data-play="26"></div>
</div>
<!--弹出层-->
<div class="cover"></div>
<div class="pop pop-red-div clearfix">
	<span class="pop-red">6</span><span class="pop-red">7</span>
