...
<div class="page-from-left index">
	<div class="top fix">
    	<div class="top-relative clearfix">
        	...
        	<span class="title"><span class="pt2">11选5</span><a class="selmore" href="javascript:void(-1)">任选八<img src="img/down_yellow.png"/></a></span>
        </div>
    </div>
    <div class="cb"></div>
<!--顶部结束-->
...
<!--投注底部开始-->
    ...
    <div id="game" style="display:none" data-game="T05" data-play="28"></div>
</div>
<!--弹出层-->
<div class="cover"></div>
<div class="pop pop-red-div clearfix" style="height:64px; margin-top:32px; text-align:center;">
    <span class="pop-red">8</span>
</div>
