...
<div class="page-from-left index">
	<div class="top fix">
    	<div class="top-relative clearfix">
        	...
        	<span class="title"><span class="pt2">11选5</span><a class="selmore" href="javascript:void(-1)">前二直选<img src="img/down_yellow.png"/></a></span>
        </div>
    </div>
    <div class="cb"></div>
<!--顶部结束-->
	...
	<div class="content">
        ...
        <div class="xuanqiu">
            <div class="bar-tip nav2 mb5 clearfix">
                ...
                <!--<a class="tab-nav more-tou" style="width:25%;">和值</a>
                <a class="tab-nav more-tou" style="width:25%;">跨度</a>-->
            </div>
            <div class="tab-content p10" id="dpailei"  data-type="1">
            	<p class="gerytext pl10">玩法提示：每位各选1个号码。1/110的中奖机会，奖金130元。</p>
            	<div class="clearfix pailei">
                    <div class="fl wei">一位</div>
                    <div class="weiright">
                        <span class="redball">01</span><span class="redball">02</span><span class="redball">03</span>
                        <span class="redball">04</span><span class="redball">05</span><span class="redball">06</span><span class="redball">07</span>
                        <span class="redball">08</span><span class="redball">09</span><span class="redball">10</span><span class="redball">11</span>
                    </div>
                 </div>  
                 <div class="clearfix pailei">
            ...
            <div class="tab-content p10" id="putong" style="display:block;"  data-red="2" data-blue="0" data-type="2" data-des="前二直选">
            	<p class="gerytext pl10">玩法提示：所选号码与开奖号码前两位一致即中奖，奖金130元。</p>
                <span class="tz-tit-left"><font class="redtext"></font>至少选2个号码</span>
            ...
            <!--<div class="tab-content p10" id="hezhi" data-arr="2,2,4,4,6,6,8,8,10,10,10,8,8,6,6,4,4,2,2" data-type="3">
            	<p class="gerytext pl10">玩法提示：所选和值与开奖号码前两位之和的值相同即中奖，奖金130元。</p>
            ...
            <!--<div class="tab-content p10" id="kuadu" data-arr="20,18,16,14,12,10,8,6,4,2" data-type="4">
            	<p class="gerytext pl10">玩法提示：所选号码与开奖号码前两位之差的值相同即中奖，奖金130元。</p>
                <span class="tz-tit-left">至少选择1个跨度号码</span>
                <div class="cb"></div>
                <div class="clearfix">
                   <span class="redball">1</span><span class="redball">2</span>
                   <span class="redball">3</span><span class="redball">4</span><span class="redball">5</span>
                   <span class="redball">6</span><span class="redball">7</span><span class="redball">8</span>
                   <span class="redball">9</span><span class="redball">10</span>
                </div>
            </div>-->
        </div>
        <!--选球结束-->
...
<!--投注底部开始-->
    ...
    <div id="game" style="display:none" data-game="T05" data-play="30"></div>
</div>
<!--弹出层-->
<div class="cover"></div>
