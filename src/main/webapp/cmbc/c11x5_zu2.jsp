...
<div class="page-from-left index">
	<div class="top fix">
    	<div class="top-relative clearfix">
        	...
        	<span class="title"><span class="pt2">11选5</span><a class="selmore" href="javascript:void(-1)">前二组选<img src="img/down_yellow.png"/></a></span>
        </div>
    </div>
    <div class="cb"></div>
<!--顶部结束-->
<!--正文内容开始-->
	<div class="content">
        ...
        <div class="xuanqiu">
            ...
            <div class="tab-content p10" id="putong"  data-red="2" data-blue="0" data-type="2" data-des="前二组选" style="display:block;">
            	<p class="gerytext pl10">玩法提示：任意2个号码组成1注有效注，1/55的中奖机会，奖金65元。</p>
            ...
            <div class="tab-content p10" id="dantuo">
            	<p class="gerytext pl10">玩法提示：胆码选1个，拖码可选2-10个，胆码加拖码>=3个，奖金65元。</p>
                ...
                <span class="tz-tit-left mt10"><font class="redtext">拖码区</font>胆码与托码个数之和至少3个</span>
                <div class="cb"></div>
...
<!--投注底部开始-->
    ...
    <div id="game" style="display:none" data-game="T05" data-play="29"></div>
</div>
<!--弹出层-->
<div class="cover"></div>
