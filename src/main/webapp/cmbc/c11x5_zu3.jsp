...
<div class="page-from-left index">
    ...
    <div class="content">
        ...
        <div class="xuanqiu">
            <div class="bar-tip nav2 mb5 clearfix">
                <a class="tab-nav more-tou now" style="width:50%;">普通投注</a>
                <a class="tab-nav more-tou" style="width:50%;">胆拖</a>
            </div>
            <div class="tab-content p10" id="putong" data-red="3" data-blue="0" data-type="3" data-des="前三组选"
                 style="display:block;">
                <p class="gerytext pl10">玩法提示：任意3个号码组成1注有效注，1/165的中奖机会，奖金195元。</p>
                <span class="tz-tit-left"><font class="redtext"></font>至少选3个号码</span>
                <span class="tz-tit-right1 red" id="jx-hq">3个</span>
                <span class="tz-tit-right2 red" onClick="selqiu($('#putong').find('.redball'),3)">机选号码</span>
            ...
            <div class="tab-content p10" id="dantuo">
                <p class="gerytext pl10">玩法提示：胆码可选1-2个，拖码可选2-10个，胆码加拖码>=4个，奖金195元。</p>
                <span class="tz-tit-left"><font class="redtext">胆码区</font>请选择一个号码</span>
    ...
    <div class="footer-tz">
    	<span id="meizhu">
        	<span id="ptmeizhu" class="meizhu" style="display:block;">
    			<a class="del-red" href="javascript:void(-1)" id="del-ball-pt"></a>
        		<span class="fl">共<font class="redtext meizhushu" id="ptzhushu">0</font>注
           		<font class="redtext meizhuqian" id="ptqianshu">0</font>元</span>
             </span>
             <span id="dtmeizhu" class="meizhu" style="display:none;">
    			<a class="del-red" href="javascript:void(-1)" id="del-ball-dt"></a>
        		<span class="fl">共<font class="redtext meizhushu" id="dtzhushu">0</font>注
           		<font class="redtext meizhuqian" id="dtqianshu">0</font>元</span>
             </span>
        </span>
        <span id="qi-bei">
    ...
    <script type="text/javascript" src="js/c11x5zu2zu3.js"></script>
    <script type="text/javascript" src="js/contect11x5.js"></script>
    <div id="game" style="display:none" data-game="T05" data-play="31"></div>
</div>
<!--弹出层-->
<div class="cover"></div>
<div class="pop pop-red-div clearfix">
    <span class="pop-red">3</span><span class="pop-red">4</span>
...
<div class="pop pop-renxuan-div clearfix">
    ...
    <div class="pop-renxuan-dd">
        <a href="c11x5_2.jsp" class="pop-red">任选二</a><a href="c11x5_3.jsp" class="pop-red">任选三</a><a href="c11x5_4.jsp"
                                                                                                     class="pop-red">任选四</a>
        <a href="c11x5.jsp" class="pop-red">任选五</a><a href="c11x5_6.jsp" class="pop-red">任选六</a><a href="c11x5_7.jsp"
                                                                                                   class="pop-red">任选七</a>
        <a href="c11x5_8.jsp" class="pop-red">任选八</a><a href="c11x5_z1.jsp" class="pop-red">前一直选</a><a
            href="c11x5_z2.jsp" class="pop-red">前二直选</a>
        <a href="c11x5_zu2.jsp" class="pop-red">前二组选</a><a href="c11x5_z3.jsp" class="pop-red">前三直选</a><a
            href="c11x5_zu3.jsp" class="pop-red">前三组选</a>
    </div>
</div>
<!--弹出层结束-->
</body>
