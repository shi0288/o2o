...
<div class="page-from-left index">
	<div class="top fix">
    	<div class="top-relative clearfix">
        	...
        	<span class="title"><span class="pt2">福彩3D</span><a class="selmore" href="javascript:void(-1)">直选<img src="img/down_yellow.png"/></a></span>
        </div>
    </div>
    <div class="cb"></div>
<!--顶部结束-->
	...
	<div class="content">
        ...
        <div class="xuanqiu">
            <div class="bar-tip nav2 mb5 clearfix">
            	<a class="tab-nav more-tou now" style="width:50%;">普通</a>
                <a class="tab-nav more-tou" style="width:50%;">和值</a>
            </div>
            ...
            <div class="tab-content p10" id="hezhi" data-arr="1,3,6,10,15,21,28,36,45,55,63,69,73,75,75,73,69,63,55,45,36,28,21,15,10,6,3,1" data-type="3">
             ...
             <div id="putong" data-red="3" data-blue="0" data-type="2" data-des="直选" style="display:none">
...
<!--投注底部开始-->
	<div class="footer-tz">
     ...
     <div id="game" style="display:none" data-game="F02" data-play="01"></div>
</div>
<!--弹出层-->
<div class="cover"></div>
