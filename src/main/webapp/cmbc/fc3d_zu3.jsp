...
<div class="page-from-left index">
	<div class="top fix">
    	<div class="top-relative clearfix">
        	...
        	<span class="title"><span class="pt2">福彩3D</span><a class="selmore" href="javascript:void(-1)">组选三<img src="img/down_yellow.png"/></a></span>
        </div>
    </div>
    <div class="cb"></div>
<!--顶部结束-->
...
<!--投注底部开始-->
	<div class="footer-tz">
     ...
     <div id="game" style="display:none" data-game="F02" data-play="02"></div>
</div>
<!--弹出层-->
<div class="cover"></div>
