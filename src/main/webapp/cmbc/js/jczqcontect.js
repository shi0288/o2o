    ...
    $(".jc-list-item").each(function (index, element) {
        ...
        $(this).find(".jc-list-item-dw.on").each(function (i, val) {
            if (i == $(this).parent().find(".jc-list-item-dw.on").length - 1) {
                strNum += $(this).attr("data-dit").substring(1)+'@'+$(this).attr("data-odds");
            } else {
                strNum += $(this).attr("data-dit").substring(1)+'@'+$(this).attr("data-odds") + ",";
            }
            ...
            if(oodsCode=='cn01'){
                ...
                if (rqspfdata) {
                    ...
                    if(selling=="Selling"&&(closeTime-now>0)&&rqspfdata[0]!="--"){
                        rqspfdata_one = '<td width="18%" data-dit="v3" data-odds="'+ rqspfdata[0] +'" onclick="seleMatch(this)">胜' + rqspfdata[0] + '</td>';
                        rqspfdata_two = '<td width="18%" data-dit="v1" data-odds="'+ rqspfdata[1] +'" onclick="seleMatch(this)">平' + rqspfdata[1] + '</td>';
                        rqspfdata_three = '<td width="18%" data-dit="v0" data-odds="'+ rqspfdata[2] +'" onclick="seleMatch(this)">负' + rqspfdata[2] + '</td>';
                    }else{
                ...
                if (spfdata) {
                   ...
                   // }
                    if(selling=="Selling"&&(closeTime-now>0)&&spfdata[0]!="--"){
                        spfdata_one = '<td width="24%" data-dit="v3" data-odds="'+ spfdata[0] +'" onclick="seleMatch(this)">胜' + spfdata[0] + '</td>';
                        spfdata_two = '<td width="24%" data-dit="v1" data-odds="'+ spfdata[1] +'" onclick="seleMatch(this)">平' + spfdata[1] + '</td>';
                        spfdata_three = '<td width="24%" data-dit="v0" data-odds="'+ spfdata[2] +'" onclick="seleMatch(this)">负' + spfdata[2] + '</td>';
                    }else{
                ...
                if (spfdata) {
                    ...
                    if(selling=="Selling"&&(closeTime-now>0)&&spfdata[0]!=""){
                        var spfdata_one = '<td data-dit="v10" data-odds="'+ spfdata[0] +'" width="10%" onclick="seleMatch(this)"><p>1:0</p><p>' + spfdata[0] + '</p></td>';
                        var spfdata_two = '<td data-dit="v20" data-odds="'+ spfdata[1] +'" width="10%" onclick="seleMatch(this)"><p>2:0</p><p>' + spfdata[1] + '</p></td>';
                        var spfdata_three = '<td data-dit="v21" data-odds="'+ spfdata[2] +'" width="10%" onclick="seleMatch(this)"><p>2:1</p><p>' + spfdata[2] + '</p></td>';
                        var spfdata_four = '<td data-dit="v30" data-odds="'+ spfdata[3] +'" width="10%" onclick="seleMatch(this)"><p>3:0</p><p>' + spfdata[3] + '</p></td>';
                        var spfdata_five = '<td data-dit="v31" data-odds="'+ spfdata[4] +'" width="10%" onclick="seleMatch(this)"><p>3:1</p><p>' + spfdata[4] + '</p></td>';
                        var spfdata_six = '<td data-dit="v32" data-odds="'+ spfdata[5] +'" width="10%" onclick="seleMatch(this)"><p>3:2</p><p>' + spfdata[5] + '</p></td>';
                        var spfdata_seven = '<td data-dit="v40" data-odds="'+ spfdata[6] +'" width="10%" onclick="seleMatch(this)"><p>4:0</p><p>' + spfdata[6] + '</p></td>';
                        var spfdata_eight = '<td data-dit="v41" data-odds="'+ spfdata[7] +'" width="10%" onclick="seleMatch(this)"><p>4:1</p><p>' + spfdata[7] + '</p></td>';
                        var spfdata_nine = '<td data-dit="v42" data-odds="'+ spfdata[8] +'" width="10%" onclick="seleMatch(this)"><p>4:2</p><p>' + spfdata[8] + '</p></td>';
                        var spfdata_ten = '<td data-dit="v50" data-odds="'+ spfdata[9] +'" width="10%" onclick="seleMatch(this)"><p>5:0</p><p>' + spfdata[9] + '</p></td>';
                        var spfdata_eleven = '<td data-dit="v51" data-odds="'+ spfdata[10] +'" width="10%" onclick="seleMatch(this)"><p>5:1</p><p>' + spfdata[10] + '</p></td>';
                        var spfdata_twelve = '<td data-dit="v52" data-odds="'+ spfdata[11] +'" width="10%" onclick="seleMatch(this)"><p>5:2</p><p>' + spfdata[11] + '</p></td>';
                        var spfdata_thirteen = '<td data-dit="v90" data-odds="'+ spfdata[12] +'" width="10%" colspan="2" onclick="seleMatch(this)"><p>胜其他</p><p>' + spfdata[12] + '</p></td>';
                        ...
                        var spfdata_one2 = '<td data-dit="v00" data-odds="'+ spfdata[13] +'" width="10%" onclick="seleMatch(this)"><p>0:0</p><p>' + spfdata[13] + '</p></td>';
                        var spfdata_two2 = '<td data-dit="v11" data-odds="'+ spfdata[14] +'" width="10%" onclick="seleMatch(this)"><p>1:1</p><p>' + spfdata[14] + '</p></td>';
                        var spfdata_three2 = '<td data-dit="v22" data-odds="'+ spfdata[15] +'" width="10%" onclick="seleMatch(this)"><p>2:2</p><p>' + spfdata[15] + '</p></td>';
                        var spfdata_four2 = '<td data-dit="v33" data-odds="'+ spfdata[16] +'" width="10%" onclick="seleMatch(this)"><p>3:3</p><p>' + spfdata[16] + '</p></td>';
                        var spfdata_five2 = '<td data-dit="v99" data-odds="'+ spfdata[17] +'" width="10%" colspan="3" onclick="seleMatch(this)"><p>平其他</p><p>' + spfdata[17] + '</p></td>';
                        ...
                        var spfdata_one3 = '<td data-dit="v01" data-odds="'+ spfdata[18] +'" width="10%" onclick="seleMatch(this)"><p>0:1</p><p>' + spfdata[18] + '</p></td>';
                        var spfdata_two3 = '<td data-dit="v02" data-odds="'+ spfdata[19] +'" width="10%" onclick="seleMatch(this)"><p>0:2</p><p>' + spfdata[19] + '</p></td>';
                        var spfdata_three3 = '<td data-dit="v12" data-odds="'+ spfdata[20] +'" width="10%" onclick="seleMatch(this)"><p>1:2</p><p>' + spfdata[20] + '</p></td>';
                        var spfdata_four3 = '<td data-dit="v03" data-odds="'+ spfdata[21] +'" width="10%" onclick="seleMatch(this)"><p>0:3</p><p>' + spfdata[21] + '</p></td>';
                        var spfdata_five3 = '<td data-dit="v13" data-odds="'+ spfdata[22] +'" width="10%" onclick="seleMatch(this)"><p>1:3</p><p>' + spfdata[22] + '</p></td>';
                        var spfdata_six3 = '<td data-dit="v23" data-odds="'+ spfdata[23] +'" width="10%" onclick="seleMatch(this)"><p>2:3</p><p>' + spfdata[23] + '</p></td>';
                        var spfdata_seven3 = '<td data-dit="v04" data-odds="'+ spfdata[24] +'" width="10%" onclick="seleMatch(this)"><p>0:4</p><p>' + spfdata[24] + '</p></td>';
                        var spfdata_eight3 = '<td data-dit="v14" data-odds="'+ spfdata[25] +'" width="10%" onclick="seleMatch(this)"><p>1:4</p><p>' + spfdata[25] + '</p></td>';
                        var spfdata_nine3 = '<td data-dit="v24" data-odds="'+ spfdata[26] +'" width="10%" onclick="seleMatch(this)"><p>2:4</p><p>' + spfdata[26] + '</p></td>';
                        var spfdata_ten3 = '<td data-dit="v05" data-odds="'+ spfdata[27] +'" width="10%" onclick="seleMatch(this)"><p>0:5</p><p>' + spfdata[27] + '</p></td>';
                        var spfdata_eleven3 = '<td data-dit="v15" data-odds="'+ spfdata[28] +'" width="10%" onclick="seleMatch(this)"><p>1:5</p><p>' + spfdata[28] + '</p></td>';
                        var spfdata_twelve3 = '<td data-dit="v25" data-odds="'+ spfdata[29] +'" width="10%" onclick="seleMatch(this)"><p>2:5</p><p>' + spfdata[29] + '</p></td>';
                        var spfdata_thirteen3 = '<td data-dit="v09" data-odds="'+ spfdata[30] +'" width="10%" colspan="2" onclick="seleMatch(this)"><p>负其他</p><p>' + spfdata[30] + '</p></td>';
                ...
                if (spfdata) {
                    spfdata = spfdata.split("|");
                    if(selling=="Selling"&&(closeTime-now>0)&&spfdata[0]!=""){
                        var spfdata_one = '<td data-dit="v0" data-odds="'+ spfdata[0] +'" width="18%" onclick="seleMatch(this)"><p>0球</p><p>' + spfdata[0] + '</p></td>';
                        var spfdata_two = '<td data-dit="v1" data-odds="'+ spfdata[1] +'" width="18%" onclick="seleMatch(this)"><p>1球</p><p>' + spfdata[1] + '</p></td>';
                        var spfdata_three = '<td data-dit="v2" data-odds="'+ spfdata[2] +'" width="18%" onclick="seleMatch(this)"><p>2球</p><p>' + spfdata[2] + '</p></td>';
                        var spfdata_four = '<td data-dit="v3" data-odds="'+ spfdata[3] +'" width="18%" onclick="seleMatch(this)"><p>3球</p><p>' + spfdata[3] + '</p></td>';
                        var spfdata_five = '<td data-dit="v4" data-odds="'+ spfdata[4] +'" width="18%" onclick="seleMatch(this)"><p>4球</p><p>' + spfdata[4] + '</p></td>';
                        var spfdata_six = '<td data-dit="v5" data-odds="'+ spfdata[5] +'" width="18%" onclick="seleMatch(this)"><p>5球</p><p>' + spfdata[5] + '</p></td>';
                        var spfdata_seven = '<td data-dit="v6" data-odds="'+ spfdata[6] +'" width="18%" onclick="seleMatch(this)"><p>6球</p><p>' + spfdata[6] + '</p></td>';
                        var spfdata_eight = '<td data-dit="v7" data-odds="'+ spfdata[7] +'" width="18%" onclick="seleMatch(this)"><p>7+球</p><p>' + spfdata[7] + '</p></td>';
                ...
                if (spfdata) {
                    spfdata = spfdata.split("|");
                    if(selling=="Selling"&&(closeTime-now>0)&&spfdata[0]!=""){
                        var spfdata_one = '<td data-dit="v33" data-odds="'+ spfdata[0] +'" width="14%" onclick="seleMatch(this)"><p>胜胜</p><p>' + spfdata[0] + '</p></td>';
                        var spfdata_two = '<td data-dit="v31" data-odds="'+ spfdata[1] +'" width="14%" onclick="seleMatch(this)"><p>胜平</p><p>' + spfdata[1] + '</p></td>';
                        var spfdata_three = '<td data-dit="v30" data-odds="'+ spfdata[2] +'" width="14%" onclick="seleMatch(this)"><p>胜负</p><p>' + spfdata[2] + '</p></td>';
                        var spfdata_four = '<td data-dit="v13" data-odds="'+ spfdata[3] +'" width="14%" onclick="seleMatch(this)"><p>平胜</p><p>' + spfdata[3] + '</p></td>';
                        var spfdata_five = '<td data-dit="v11" data-odds="'+ spfdata[4] +'" width="14%" onclick="seleMatch(this)"><p>平平</p><p>' + spfdata[4] + '</p></td>';
                        var spfdata_six = '<td data-dit="v10" data-odds="'+ spfdata[5] +'" width="14%" onclick="seleMatch(this)"><p>平负</p><p>' + spfdata[5] + '</p></td>';
                        var spfdata_seven = '<td data-dit="v03" data-odds="'+ spfdata[6] +'" width="14%" onclick="seleMatch(this)"><p>负胜</p><p>' + spfdata[6] + '</p></td>';
                        var spfdata_eight = '<td data-dit="v01" data-odds="'+ spfdata[7] +'" width="14%" onclick="seleMatch(this)"><p>负平</p><p>' + spfdata[7] + '</p></td>';
                        var spfdata_nine = '<td data-dit="v00" data-odds="'+ spfdata[8] +'" width="14%" onclick="seleMatch(this)"><p>负负</p><p>' + spfdata[8] + '</p></td>';
