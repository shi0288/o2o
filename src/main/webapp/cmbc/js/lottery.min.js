...
function toLoadLoginPanel() {
		if(sessionStorage.getItem("UserId")!=null){
			...
			setWebitEvent("http://bank.mobilelottery.cn/cmbc/?type=1", "LT02");
//			before();
//			$.ajax({
//		        url: 'login.jsp',
//		        type: "POST",
				...
				if($(b).find("Count").text()==0){
					...
					if($(b).find('Ticket').length==0){
						...
						$(b).find('Ticket').each( function (index)  {
							...
							$("#mylot_bonus_data_list").append("<div><div  style='margin-top:8px;'>"+gameName+"&nbsp;&nbsp;&nbsp;"+GameAdapterName+"&nbsp;&nbsp;&nbsp;"+stakeTime+"</div><div style='padding-top: 5px;'>"+termId+"期&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;倍数："+times+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;金额："+money+"元</div><div style='padding-top: 5px;'>投注号码："+con_stakeNumber(game,stake1)+"&nbsp;&nbsp;"+con_stakeNumber(game,stake2)+"&nbsp;&nbsp;"+con_stakeNumber(game,stake3)+"&nbsp;&nbsp;"+con_stakeNumber(game,stake4)+"&nbsp;&nbsp;"+con_stakeNumber(game,stake5)+"</div><div><a class='graybutton' onclick='kuaisu_stake(\""+gameAdapterId+"\",\""+gameName+"\",\""+times+"\",\""+stake1+"\",\""+stake2+"\",\""+stake3+"\",\""+stake4+"\",\""+stake5+"\");'>快速投注</a></div></div>");
						});
					}
				}
			}
				...
				if($(b).find("Count").text()==0){
					...
					if($(b).find('Prize').length==0){
						...
						$(b).find('Prize').each( function (index)  {
							...
							$("#mylot_bonus_data_list").append("<div  style='margin-top:8px;'>"+gameName+"&nbsp;&nbsp;&nbsp;"+termId+"期&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;中奖金额："+bonus+"元<div style='padding-top: 5px;'>返奖日期："+returnTime+"</div><div style='padding-top: 5px;'>开奖号码："+ballhtml+"</div></div>");
						});
					}
				}
			}
						...
						$(b).find('Term').each( function (index)  {
							var  game = $( this ).children('Game').text();
			                  ...
			                  if(game=='00-4'){
			                	  gameName="胜负彩";
			                	  for(var i=0;i<winNumber.length;i++){
			                		  ballhtml+="<span class='red_text' style='padding-left:6px;'>"+winNumber.substring(i,i+1)+"</span>";
			                	  }
			                  }
			                  if(game=='00-A'){
			                	  gameName="四场进球";
							  ...
							  var htmls = "<div  style='padding-top:10px;'>"+gameName+"&nbsp;<span class='smalllast_win'>"+termId+"期&nbsp;"+openDate+"</span><div style='padding-top: 5px;'>"+ballhtml+"</div></div>";
