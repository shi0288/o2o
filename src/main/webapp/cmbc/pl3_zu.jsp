...
<div class="page-from-left index">
    ...
    <!--正文内容开始-->
    <div class="content">
        <div class="bar-tip"><span>第<font class="redtext" id="termCode">14197</font>期</span><span>截止时间：<font
                class="redtext" id="lastime">12-29 16:00</font></span></div>
        <!--选球-->
        <div class="xuanqiu">
            <div class="bar-tip nav2 mb5 clearfix">
                <!--<a class="tab-nav more-tou now" style="width:50%;">单式组选</a>-->
                <a class="tab-nav more-tou now" style="width:100%;">组选和值</a>
            </div>
            <div class="p10 onlyball" id="pailei" style="display:none;" data-type="1">
                <p class="gerytext pl10">玩法提示：每位只能选择1个号码。</p>

                <div class="clearfix pailei">
                    <div class="fl wei">百位</div>
                    <div class="weiright">
                        <span class="redball">0</span><span class="redball">1</span><span class="redball">2</span><span
                            class="redball">3</span>
                        <span class="redball">4</span><span class="redball">5</span><span class="redball">6</span><span
                            class="redball">7</span>
            ...
            <div class="tab-content p10" id="hezhi"
                 data-arr="1,2,2,4,5,6,8,10,11,13,14,14,15,15,14,14,13,11,10,8,6,5,4,2,2,1" data-type="3"
                 style="display:block;">
        ...
        <div id="putong" data-red="3" data-blue="0" data-type="2" data-des="组选" style="display:none;">
            <span class="redball">0</span><span class="redball">1</span><span class="redball">2</span><span
                class="redball">3</span>
            <span class="redball">4</span><span class="redball">5</span><span class="redball">6</span><span
                class="redball">7</span>
    ...
    <div id="game" style="display:none" data-game="T03" data-play="04"></div>
</div>
<!--弹出层-->
<div class="cover"></div>
