...
<div class="page-from-left index">
	<div class="top fix">
    	<div class="top-relative clearfix">
        	...
        	<span class="title"><span class="pt2">排列三</span><a class="selmore" href="javascript:void(-1)">组选三<img src="img/down_yellow.png"/></a></span>
        </div>
    </div>
    <div class="cb"></div>
<!--顶部结束-->
	...
	<div class="content">
        ...
        <div class="xuanqiu">
            <div class="bar-tip nav2 mb5 clearfix">
            	<a class="tab-nav more-tou now" style="width:100%;">组三复式</a>
                <!--<a class="tab-nav more-tou" style="width:33%;">跨度</a>
                <a class="tab-nav more-tou" style="width:33%;">胆拖</a>-->
            </div>
  			<div class="tab-content p10" id="putong" data-red="2" data-blue="0" data-type="2" data-des="组选三" style="display:block;">
            ...
            <!--<div class="tab-content p10" id="kuadu" data-arr="18,16,14,12,10,8,6,4,2" data-type="4">
...
<!--投注底部开始-->
	<div class="footer-tz">
     ...
     <div id="game" style="display:none" data-game="T03" data-play="02"></div>
</div>
<!--弹出层-->
<div class="cover"></div>
