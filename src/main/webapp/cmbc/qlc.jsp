...
<!--正文内容开始-->
	...
	<div class="content">
        ...
        <div class="xuanqiu">
            ...
            <div class="tab-content clearfix  p10" id="putong" style="display:block" data-red="7" data-blue="0">
                <span class="tz-tit-left"><font class="redtext"></font>至少选7个号码</span>
            ...
            <div class="tab-content p10" id="dantuo">
                ...
                <span class="tz-tit-left mt10"><font class="redtext">拖码区</font>至少选择2个</span>
                <div class="cb"></div>
...
<!--投注底部开始-->
    ...
    <div id="game" style="display:none" data-game="F03" data-play="00"></div>
</div>
</body>
</html>
